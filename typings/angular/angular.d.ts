/**
 * Created by jeremy on 2017/6/23.
 */
...
declare module angular {
    ...
    // All services providers extend this interface
    ...
    interface IModule {
         ...
         *
         * @param configFn Execute this function on module load. Useful for services configuration.
         */
        config(configFn: Function): IModule;
        /**
         * Use this method to register work which needs to be performed on module loading.
         *
         * @param inlineAnnotatedFunction Execute this function on module load. Useful for services configuration.
         */
        config(inlineAnnotatedFunction: any[]): IModule;
        /**
         * Register a constant services, such as a string, a number, an array, an object or a function, with the $injector. Unlike value it can be injected into a module configuration function (see config) and it cannot be overridden by an Angular decorator.
         *
        ...
        /**
         * The $controller services is used by Angular to create new controllers.
         *
        ...
        /**
         * Register a services factory, which will be called to return the services instance. This is short for registering a services where its provider consists of only a $get property, which is the given services factory function. You should use $provide.factory(getFn) if you do not need to configure your services in a provider.
         *
        ...
        /**
         * Register a value services with the $injector, such as a string, a number, an array, an object or a function. This is short for registering a services where its provider's $get property is a factory function that takes no arguments and returns the value services.
        ...
        /**
         * Register a services decorator with the $injector. A services decorator intercepts the creation of a services, allowing it to override or modify the behaviour of the services. The object returned by the decorator may be the original services, or a new services object which replaces or wraps and delegates to the original services.
         * @param name The name of the services to decorate
         * @param decorator This function will be invoked when the services needs to be instantiated and should return the decorated services instance. The function is called using the injector.invoke method and is therefore fully injectable. Local injection arguments: $delegate - The original services instance, which can be monkey patched, configured, decorated or delegated to.
         */
    ...
    /**
     * $rootScope - $rootScopeProvider - services in module ng
    ...
    interface IRootScopeService {
         ...
         *
         * Any exception emitted from the listeners will be passed onto the $exceptionHandler services.
         *
    ...
    /**
     * $filter - $filterProvider - services in module ng
     *
    ...
    /**
     * $location - $locationProvider - services in module ng
    ...
    /**
     * $cacheFactory - services in module ng
     *
    ...
    interface IHttpProvider extends IServiceProvider {
        ...
        /**
         * Register services factories (names or implementations) for interceptors which are called before and after
         * each request.
         */
    ...
    // You should never need to use this services directly.
    ///////////////////////////////////////////////////////////////////////////
    ...
    export module auto {
        ...
        interface IProvideService {
             ...
             *
             * @param name The name of the services to decorate.
             * @param decorator This function will be invoked when the services needs to be instantiated and should return the decorated services instance. The function is called using the injector.invoke method and is therefore fully injectable. Local injection arguments:
             *
             * $delegate - The original services instance, which can be monkey patched, configured, decorated or delegated to.
             */
             ...
             *
             * @param name The name of the services to decorate.
             * @param inlineAnnotatedFunction This function will be invoked when the services needs to be instantiated and should return the decorated services instance. The function is called using the injector.invoke method and is therefore fully injectable. Local injection arguments:
             *
             * $delegate - The original services instance, which can be monkey patched, configured, decorated or delegated to.
             */
